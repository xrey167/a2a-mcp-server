...
| `src/workers/code.ts` | 8084 | codex_exec, codex_review, explain_code (via `codex exec` subprocess) |
| `src/workers/knowledge.ts` | 8085 | create_note, read_note, update_note, search_notes, list_notes, summarize_notes |
